/**********************************************
2016 Biomedical Engineering Senior Design
Group 1: Chris Auld, Kevin Babineau, Laura Healey
Tactile Imaging Team
...
#define SET_SR_DATA_HIGH()        PORTD|=B00000100 		// these are changing the pins high/low
#define SET_SR_DATA_LOW()         PORTD&=~B00000100 	// they might fuck up the other pins on port d
#define SET_SR_CLK_HIGH()         PORTD|=B00001000 		// so we might have to change these and the 
#define SET_SR_CLK_LOW()          PORTD&=~B00001000 	// shiftCoumn() function - Chris
